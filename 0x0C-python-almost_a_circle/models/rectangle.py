...
class Rectangle(Base):
    ''''Rectangle Class of  methods and fields'''
    ...
    def area(self):
        '''Method to return the area of class Rectangle'''
    ...
    def to_dictionary(self):
        '''Method to return dictionary representaton of rectangle'''
        dictt = {'id': self.id, 'width': self.width, 'height': self.height,
                 'x': self.x, 'y': self.y}
        return dictt
